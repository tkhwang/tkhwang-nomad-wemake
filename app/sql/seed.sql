...
VALUES
  ('DevTool Pro', 'The ultimate developer toolkit', 'Comprehensive development suite', 'Easy integration with existing workflow', '/icons/devtool.png', 'https://devtool.pro', '{"views": 0, "reviews": 0}', 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 1, NOW(), NOW()),
  ('DesignMaster', 'Design like a pro', 'Professional design platform', 'Intuitive interface for designers', '/icons/design.png', 'https://designmaster.app', '{"views": 0, "reviews": 0}', 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 2, NOW(), NOW()),
  ('MarketGenius', 'Smart marketing automation', 'AI-powered marketing platform', 'Automated marketing workflows', '/icons/market.png', 'https://marketgenius.io', '{"views": 0, "reviews": 0}', 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 3, NOW(), NOW()),
  ('CodeBuddy', 'Your coding companion', 'AI pair programming assistant', 'Real-time code suggestions', '/icons/code.png', 'https://codebuddy.dev', '{"views": 0, "reviews": 0}', 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 4, NOW(), NOW()),
  ('DataViz', 'Beautiful data visualization', 'Turn data into insights', 'Drag-and-drop visualization builder', '/icons/dataviz.png', 'https://dataviz.app', '{"views": 0, "reviews": 0}', 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 5, NOW(), NOW());

-- Seed product upvotes (bridge table)
INSERT INTO product_upvotes (product_id, profile_id)
VALUES (1, 'f6ceb3be-fafd-4591-9897-1159e1d060d0');

-- Seed reviews
INSERT INTO reviews (product_id, profile_id, rating, review, created_at, updated_at)
VALUES
  (1, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 5, 'Excellent developer tool!', NOW(), NOW()),
  (2, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 4, 'Great design features', NOW(), NOW()),
  (3, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 5, 'Amazing marketing automation', NOW(), NOW()),
  (4, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 4, 'Very helpful coding assistant', NOW(), NOW()),
  (5, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 5, 'Powerful visualization tool', NOW(), NOW());
...
VALUES
  ('Getting Started with DevTool Pro', 'A comprehensive guide to DevTool Pro...', 1, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', NOW(), NOW()),
  ('Design Tips and Tricks', 'Essential design principles...', 2, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', NOW(), NOW()),
  ('Marketing Automation Best Practices', 'How to automate your marketing...', 3, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', NOW(), NOW()),
  ('Launching Your First Product', 'Steps to a successful product launch...', 4, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', NOW(), NOW()),
  ('AI in Modern Development', 'How AI is changing development...', 5, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', NOW(), NOW());
...
VALUES
  (1, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 'Great post about DevTool Pro!', NOW(), NOW()),
  (2, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 'These design tips are very helpful', NOW(), NOW()),
  (3, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 'Marketing automation is crucial', NOW(), NOW()),
  (4, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 'Launch strategy is on point', NOW(), NOW()),
  (5, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 'AI is indeed transforming development', NOW(), NOW());

-- Seed gpt ideas
INSERT INTO gpt_ideas (idea, views, claimed_by, created_at)
VALUES
  ('AI-powered code review assistant', 0, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', NOW()),
...
VALUES (1, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', NOW());

-- Seed messages
INSERT INTO messages (message_room_id, sender_id, content, created_at)
VALUES
  (1, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 'Hello! Interested in collaboration', NOW()),
  (1, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 'Let''s discuss the project details', NOW()),
  (1, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 'What''s your availability?', NOW()),
  (1, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 'I can start next week', NOW()),
  (1, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 'Great, looking forward to working together', NOW());

-- Seed notifications
INSERT INTO notifications (source_id, product_id, post_id, target_id, type, created_at)
VALUES
  ('f6ceb3be-fafd-4591-9897-1159e1d060d0', 1, NULL, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 'review', NOW()),
  ('f6ceb3be-fafd-4591-9897-1159e1d060d0', NULL, 1, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 'reply', NOW()),
  ('f6ceb3be-fafd-4591-9897-1159e1d060d0', NULL, NULL, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 'follow', NOW()),
  ('f6ceb3be-fafd-4591-9897-1159e1d060d0', NULL, 2, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 'mention', NOW()),
  ('f6ceb3be-fafd-4591-9897-1159e1d060d0', 2, NULL, 'f6ceb3be-fafd-4591-9897-1159e1d060d0', 'review', NOW());
