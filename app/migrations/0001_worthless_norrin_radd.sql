CREATE TYPE "public"."role" AS ENUM('developer', 'designer', 'founder', 'product-manager');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "jobs" ADD COLUMN "skills" text NOT NULL;--> statement-breakpoint
...
ALTER TABLE "profiles" ADD CONSTRAINT "profiles_profile_id_users_id_fk" FOREIGN KEY ("profile_id") REFERENCES "auth"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "jobs" DROP COLUMN "skils";